...
- Deconstruct the winning campaigns. Instead of running back again we need to figure out why the get succeeded by breaking it into key parts:
  who we targeted, what was offer, where we advertised and how the ad looked. After analysing we can get to know about what kind of ad's should be visible
  to what kind of customers and creating ad's with new formula.
  This will increases the chances of repeating the win and business grow efficiently.
